...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/calculator--172632/1?page=2&category=Java&sortBy=submissions)

## Solved On
23 Jul 2026 at 09:23 pm

<h2><a href="https://www.geeksforgeeks.org/problems/calculator--172632/1?page=2&category=Java&sortBy=submissions">Calculator</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given two numbers&nbsp;<strong>a</strong>&nbsp;and&nbsp;<strong>b</strong>. You need to perform basic mathematical operations on them. You will be provided an integer named as <strong>operator. </strong></span></p>
<ul>
