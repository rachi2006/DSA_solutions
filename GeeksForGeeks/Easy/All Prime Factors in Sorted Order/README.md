...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/prime-factorization/1?page=2&category=Java&sortBy=submissions)

## Solved On
27 Jul 2026 at 09:35 pm

<h2><a href="https://www.geeksforgeeks.org/problems/prime-factorization/1?page=2&category=Java&sortBy=submissions">All Prime Factors in Sorted Order</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given a number <strong>n </strong>find the prime factorization of the number.</span></p>
