...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/check-the-status/1?page=1&category=python&sortBy=submissions)

## Solved On
08 Aug 2026 at 07:57 am

<h2><a href="https://www.geeksforgeeks.org/problems/check-the-status/1?page=1&category=python&sortBy=submissions">Check the status - Python</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given two integer variables <strong>a</strong> and <strong>b</strong>, and a boolean variable&nbsp;<strong>flag</strong>. The task is to check the status and return accordingly.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>-10 ≤ a, b ≤ 10<br>flag<sup>&nbsp;</sup>∈ {True, False}&nbsp;</span></p>