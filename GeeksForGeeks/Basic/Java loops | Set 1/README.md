...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/java-loops-set-11726/1?page=4&category=Java&sortBy=submissions)

## Solved On
29 Jul 2026 at 10:43 pm

<h2><a href="https://www.geeksforgeeks.org/problems/java-loops-set-11726/1?page=4&category=Java&sortBy=submissions">Java loops | Set 1</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size:18px">For a given N, return an arraylist containing&nbsp;the sum of even and odd integers of the first N natural numbers.</span></p>
